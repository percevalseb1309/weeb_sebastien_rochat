function Login() {
    return (
        <div className="container mx-auto flex flex-col items-center px-6 py-20 text-center text-white">
            <h1 className="text-4xl md:text-5xl font-bold">Se connecter</h1>

            <form className="mt-8 md:w-full max-w-xl">
            ...
            <p className="mt-8 px-10 text-sm">
