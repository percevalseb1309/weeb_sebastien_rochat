          ...
          <form className="mt-16 w-full max-w-2xl border-2 border-violet-500 rounded-2xl px-10 py-6 bg-[#21223f] text-center">
              <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <input type="email" placeholder="Email"
                         className="md:col-span-2 border-b border-violet-500 text-violet-400 placeholder-violet-400 pb-2 text-center focus:outline-none focus:border focus:rounded focus:border-violet-400 transition duration-200"/>
